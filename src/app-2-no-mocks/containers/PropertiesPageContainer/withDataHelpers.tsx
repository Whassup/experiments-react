  ...
  (data: PropertyData) => {
    ...
    return (
      <PropertyCard
        ...
        href={slug}
        attributes={getPropertyAttributesWithData(data.property)}
...
export const getPropertyListWithData = (
  ...
  const savedPropertyCards = savedProperties.map(getSavedPropertyCardWithData);
...
getPropertyListWithData: (data: PropertyResultsData, savedProperties: PropertyData[])  => JSX.Element
) => ({data, savedProperties, loading} : {data?: PropertyResultsData, savedProperties: PropertyData[], loading: boolean}) => {
